...
void create_prev(std::vector<glm::vec4>& prev_vertices, 
	...
	prev_vertices.push_back(glm::vec4(-1.0, -1.0, 0.0, 1.0));
	prev_vertices.push_back(glm::vec4(-1.0, 1.0, 0.0, 1.0));
	prev_vertices.push_back(glm::vec4(1.0, -1.0, 0.0, 1.0));
	prev_vertices.push_back(glm::vec4(1.0, 1.0, 0.0, 1.0));

	prev_faces.push_back(glm::uvec3(0, 2, 3));
	prev_faces.push_back(glm::uvec3(1, 0, 3));

	prev_coords.push_back(glm::vec2(0.0, 0.0));
	prev_coords.push_back(glm::vec2(0.0, 1.0));
	prev_coords.push_back(glm::vec2(1.0, 0.0));
	prev_coords.push_back(glm::vec2(1.0, 1.0));		
} 
